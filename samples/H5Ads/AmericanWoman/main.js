...
vid_tl
	...
	// tt
	.from(vid_tt, .75, {alpha:0, ease:Power0.easeIn}, 0)
	//.from(vid_tt, 1.75, {scale:.9, transformOrigin:"15% 60%", ease:Elastic.easeOut}, 0)
	.from(vid_tt, .5, {scale:.9, transformOrigin:"50% 60%"}, 0)
...
end_tl
	...
	.from(end_tt, .75, {alpha:0, ease:Power0.easeIn}, "t1")
	.from(end_tt, .5, {scale:.7, transformOrigin:"50% 60%"}, 0)
...
function dateChecker(){
	...
	var targetDates = [
		// [month, day, year, hour]
		[6, 10, 2019, 10],	// targetDate2
		[6, 14, 2019, 0]	 // targetDate3
		/*
